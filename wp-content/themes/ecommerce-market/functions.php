...
function ecommerce_market_scripts() {
    ...
    $fonts_url = ecommerce_market_fonts_url();

    if ( ! empty( $fonts_url ) ) {
        wp_enqueue_style( 'ecommerce-market-google-fonts', $fonts_url, array(), null );
    }
	...
	//owl carousel
	wp_enqueue_script( 'owl-carousel', get_template_directory_uri() . '/assest/js/owl.carousel.js', array('jquery'), 'v2.2.1', true );

	//isotope-docs 
	wp_enqueue_script( 'isotope', get_template_directory_uri() . '/assest/js/isotope.pkgd.js', array('jquery'), 'v2.0.8', true );

	//stellar
	wp_enqueue_script( 'stellar', get_template_directory_uri() . '/assest/js/stellar.js', array('jquery'), 'v0.6.2', true );

	//select2
	wp_enqueue_script( 'select2', get_template_directory_uri() . '/assest/js/select2.min.js', array('jquery'), '4.0.3 ', true );

	//jquery-meanmenu
	wp_enqueue_script( 'meanmenu', get_template_directory_uri() . '/assest/js/jquery.meanmenu.js', array('jquery'), 'v2.0.8', true );

	//portfolio
	wp_enqueue_script( 'portfolio', get_template_directory_uri() . '/assest/js/portfolio.js', array('jquery'), '20170905', true );

	//waypoints
    wp_enqueue_script( 'waypoints', get_template_directory_uri() . '/assest/js/jquery.waypoints.js', array('jquery'), '4.0.1', true );

    wp_enqueue_script( 'ResizeSensor', get_template_directory_uri() . '/assest/js/ResizeSensor.js', array(), '20151215', true );

    wp_enqueue_script( 'theia-sticky-sidebar', get_template_directory_uri() . '/assest/js/theia-sticky-sidebar.js', array(), '20151215', true );
    ...
    wp_enqueue_script( 'ecommerce-market-keyboard-navigation', get_template_directory_uri() . '/assest/js/keyboard-navigation.js', array(), '20151215', true );
...
if ( ! function_exists( 'ecommerce_market_fonts_url' ) ) {
    /**
     * Register Google fonts.
     *
     * @return string Google fonts URL for the theme.
     */
    function ecommerce_market_fonts_url() {
        $fonts_url = '';
        $fonts     = array();
        $subsets   = 'latin,latin-ext';
        /* translators: If there are characters in your language that are not supported by Montserrat, translate this to 'off'. Do not translate into your own language. */
        if ( 'off' !== _x( 'on', 'Montserrat', 'ecommerce-market' ) ) {
            $fonts[] = 'Montserrat:400,600,700';
        }

        /* translators: If there are characters in your language that are not supported by Montserrat, translate this to 'off'. Do not translate into your own language. */
        if ( 'off' !== _x( 'on', 'Damion', 'ecommerce-market' ) ) {
            $fonts[] = 'Damion:400';
        }
