...
class Ecommerce_Market_Promo extends WP_Widget {
	...
	function __construct() {
		...
		$opts = array(
			...
			'description'                 => esc_html__( 'A widget that displays promo section', 'ecommerce-market' ),
			'customize_selective_refresh' => true,
			);

		parent::__construct( 'ecommerce-market', esc_html__( 'EM: Promo Widget', 'ecommerce-market' ), $opts );
			...
			<div class="container">
				<div class="discount-content-wrapper">
					...
					<div class="entry-content">
						<p class="os-animation" data-os-animation="fadeInUp"><?php echo esc_textarea( $description);?></p>
    ...
    <div class="cover-image">
        ...
        <input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'ecommerce-market' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Background Image', 'ecommerce-market' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'ecommerce-market' ); ?>" style="margin-top:5px;" />
        ...
        ?>
        <div class="rtam-preview-wrap" <?php echo wp_strip_all_tags($wrap_style); ?>>
